<?php get_template_part('template_parts/content', 'click-here'); ?>
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          <div class="footer-bottom clearfix">
            <a href="http://goamv.com" target="_blank" class="powered hide-xs">
              <img src="<?php bloginfo('template_directory'); ?>/public/images/zealous.png"alt=""/>
            </a>
            <p>Copyright &copy; 2015. All rights reserved.</p>
            <?php wp_nav_menu(array( 'menu' => 'bottom-menu', 'container' => false, 'menu_class' => 'list-unstyled', 'depth' => 1, 'before' => '<span>&bull;</span>&nbsp;')); ?>
            <a href="http://goamv.com" target="_blank" class="powered show-xs">
              <img src="<?php bloginfo('template_directory'); ?>/public/images/zealous.png"alt=""/>
            </a>
          </div>
        </div>
